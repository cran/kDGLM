...
For this model, we need the geographic information about Brazil, as such, we will use some auxiliary packages, namely **geodata**, **terra**, **tidyverse**, **sf** and **spdep**, although the **kDGLM** package does not depend on them:
